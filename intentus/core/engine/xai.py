...
try:
    ...
    raise ImportError(
        "If you'd like to use Groq models, please install the openai package by running `pip install openai`, and add 'XAI_API_KEY' to your environment variables."
    )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if os.getenv("XAI_API_KEY") is None:
            raise ValueError(
                "Please set the XAI_API_KEY environment variable if you'd like to use Groq models."
            )
        ...
        if isinstance(content, str):
            ...
            if (has_multimodal_input) and (not self.is_multimodal):
                raise NotImplementedError(
                    "Multimodal generation is not supported for Groq models."
                )
